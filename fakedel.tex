...
\achievement{Developed ML models to detect fraudulent transactions, enhancing detection rates by \textbf{25\%} and reducing false positives by \textbf{15\%}.}
\achievement{Implemented a continuous monitoring system to retrain models with new data, maintaining model accuracy above \textbf{90\%}.}
\achievement{Deployed models on AWS using Docker and Kubernetes, ensuring scalable and reliable access to predictions, which improved fraud detection response times by \textbf{40\%}.}
\achievement{Collaborated with cross-functional teams to ensure seamless integration and operation of fraud detection models.}
}
\begin{comment}
\experience{Deloitte USI, \textcolor{gray}{\small Full-Time}}{Business Technology Analyst}{Jul 2021}{Jun 2022}{
