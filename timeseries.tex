...
\experience{\hyperlink{https://www.altmanctr.org/}{UC San Diego, \textcolor{gray}{\small}}}{ML Research Engineer}{Jan 2024}{Present}{
\achievement{Developed \textbf{Adverse AI}, an automated tool for detecting adverse events from unstructured text, achieving \textbf{97.5\%} accuracy in identifying adverse events from diverse text sources including medical reports and social media.}
\achievement{Implemented \textbf{BERT}-based models for AE detection, significantly reducing manual review time by \textbf{90\%}.}
\achievement{Applied Adverse AI to unstudied data, identifying critical safety signals in news articles and social media posts, thus enhancing public health surveillance.}
\achievement{Developed \textbf{HIVTrends.org}, a real-time HIV testing trends platform using internet search query data, validated against over-the-counter HIV testing kit sales data, improving prediction accuracy with \textbf{RMSE} and \textbf{Adjusted R2} metrics.}
\achievement{Utilized machine learning techniques such as \textbf{boosted regression}, \textbf{support vector machines regression}, and \textbf{lasso regression} to identify predictive search queries, enhancing the timeliness and accessibility of HIV surveillance data.}
\achievement{Developed \textbf{HIVTrends.org}, a platform for real-time HIV testing trends using regression models (Ridge, Lasso, XGBoost), achieving high accuracy (\textbf{RMSE: 0.32}, \textbf{Adjusted R2: 0.87}) by transforming search query data into predictive features and optimizing models through cross-validation.}
\achievement{Enhanced public health surveillance by providing timely, actionable insights into HIV testing trends, significantly improving prediction accuracy and timeliness using advanced feature engineering and hyperparameter tuning.}

}

\experience{\hyperlink{https://www.botdojo.com/}{BotDojo, \textcolor{gray}{\small Full-Time}}}{AI Engineer}{Mar 2024}{May 2024}{
\achievement{Developed a RAG-based no-code tool to create custom chatbots using user-uploaded data, enabling seamless API integration.}
